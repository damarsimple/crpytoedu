                    ...
                    >
                      ...
                      <article className="progress-linear">
                        <div className="progress-header">
                          <TextComponent id="about-article-1"></TextComponent>
                      ...
                      <article className="progress-linear">
                        <div className="progress-header">
                          <TextComponent id="about-article-2"></TextComponent>
                          <span className="progress-value">100</span>
                        </div>
                        <div className="progress-bar-linear-wrap">
                          <div className="progress-bar-linear"></div>
...
const LandingSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <TextComponent id="main-1-description" />
...
const useStore = create<PageStoreInterface>((set, getData) => ({
  onEdit: false,
