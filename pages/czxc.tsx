...
const Home: NextPage = () => {
  const { data } = useQuery<{ page: Page }>(
    ...
    `,
    {
      ...
      onCompleted: ({ page }) => {
        try {
          const d = JSON.parse(page.data);
          setTextMap({ ...textMap, ...d });
          rerender();
        } catch (error) {}
      },
    }
            ...
            handleMutation({
              variables: {
                ...
                input: {
                  name: "homepage",
                  route: "/",
                  data: JSON.stringify(textMap),
                },
              },
            }).then((e) => toast.success("Berhasil menyimpan data"));
          }}
        >
          Save
        </Button>
                  ...
                  <div className="row">
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-1">Mobile Apps</span>
                          </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-2">iOS Apps</span>
                          </div>
                          <div className="exeption">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-3"> Custom Software</span>
                          </div>
                          <div className="exeption">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-4"> Android Apps</span>
                          </div>
                          <div className="exeption">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-5"> Mac Apps</span>
                          </div>
                          <div className="exeption">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="gallery-item-content">
                          <div className="heading-5 title">
                            <span id="content-title-5">Software Updates </span>
                          </div>
                          <div className="exeption">
